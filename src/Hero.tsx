  ...
  return (
    <div className="flex flex-row shrink-0 top-0 gap-x-10 gap-y-10 px-[10vw] min-h-svh py-13 items-center 
      ...
      <div className="flex flex-col gap-5 max-lg:text-center">
        ...
        <button className='bg-orange-600 hover:border-orange-600 active:border-orange-600 border-solid border-2 hover:bg-white active:bg-white hover:text-orange-600 active:text-orange-600 text-white text-xl self-start max-lg:self-center py-[.7rem] px-[1.5rem]'>Be a Skibidi</button>
      </div>
